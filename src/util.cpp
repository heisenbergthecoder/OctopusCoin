...
int nAnonymizeOctopusAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Octopus
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Octopus
    // Mac: ~/Library/Application Support/Octopus
    // Unix: ~/.octopus
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Octopustiers";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "octopus.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "octopusd.pid"));
