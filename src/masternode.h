...
#define TIERED_MASTERNODES_START_BLOCK         100// tiered mns 1st block
...
// Masternode tiers
static std::map<int, int> masternodeTiers = map_list_of (1, 15000) (2, 50000) (3, 120000); 
static std::map<int, int> masternodeTiers157000 = map_list_of (1, 30000) (2, 100000) (3, 240000); 

// Masternode tier rewards
static std::map<int, int> masternodeTierRewards = map_list_of (1, 15) (2, 60) (3, 180); 
static std::map<int, int> masternodeTierRewards157000 = map_list_of (1, 27) (2, 110) (3, 336);
static std::map<int, int> masternodeTierRewards242600 = map_list_of (1, 13.5) (2, 55) (3, 168);

//
// The Masternode Class. For managing the darksend process. It contains the input of the 1000 OCTPS, signature to prove
