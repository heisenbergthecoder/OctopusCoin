...
private slots:
    ...
    QString BuyOCTPS(QString OrderType, double Quantity, double Rate);
    QString SellOCTPS(QString OrderType, double Quantity, double Rate);
