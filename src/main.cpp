...
const string strMessageMagic = "Octopus Signed Message:\n";
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    else if (pindexBest->nHeight+1 > 990 && pindexBest->nHeight+1 < TIERED_MASTERNODES_START_BLOCK)
    {
        nSubsidy = 120 * COIN;
    }
...
static int64_t nTargetTimespan = 25 * 60;  
